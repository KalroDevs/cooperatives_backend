"""
Django settings for cooperatives_backend project.
...
SECRET_KEY = 'django-insecure-1n&wrb4uwb&&9-*ljo3e@kb94k)15%$mt-48!r79b+%sk&gl0l'
...
ROOT_URLCONF = 'cooperatives_backend.urls'
...
WSGI_APPLICATION = 'cooperatives_backend.wsgi.application'
